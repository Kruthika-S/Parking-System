...
function App() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-indigo-600 via-purple-500 to-lavender-300 text-white overflow-hidden flex flex-col items-center justify-center">
      {/* Floating elements */}
